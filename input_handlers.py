...
If an action is returned it will be attempted if it's valid then
MainGameEventHandler will become the action handler.
"""
...
class EventHandler( tcod.event.EventDispatch[ Action ] ): # Subclass of EventDispatch
    ...
    def handle_action( self, action: Optional[ Action ] ) -> bool:
        ...
        self.engine.handle_enemy_turns() # Should this really be in the input handling?
...
class MainGameEventHandler( EventHandler ):
    ...
    def ev_keydown( self, event: tcod.event.KeyDown ) -> Optional[ Action ]:
        action: Optional[ Action ] = None # Colon means an assigned type? name:type=default

        # Captures the key that's being pressed
        key = event.sym
...
class HistoryViewer( EventHandler ):
    ...
    def __init__( self, engine: Engine ):
        super().__init__( engine ) # What does super mean again? The EventHandler constructor?
    ...
    def on_render( self, console: tcod.Console ) -> None:
        ...
        # Draw a frame with acustom banner title.
